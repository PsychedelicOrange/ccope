...
Now, What about intra-module conflict ?
Sure we could  solve it via internal nesting of modules. But it would look like a java nightmare
```
.
└── algorithms/
    ├── Vector/
...
- multiple value return type ( Doing a ADT struct approach, via a separate lib)
